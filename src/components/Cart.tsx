  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl z-50 flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-3.5 sm:p-4 border-b">
        ...
        <div className="flex-1 overflow-y-auto p-3.5 sm:p-4">
          {cartItems.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <p className="text-gray-600 text-base sm:text-lg mb-2">Votre panier est vide</p>
            ...
            <div className="space-y-3.5 sm:space-y-4">
              {cartItems.map((item) => (
                <div key={item.id} className="flex gap-3 sm:gap-4 bg-light-gray p-2.5 sm:p-3 rounded-lg">
                  {/* Image */}
                  <Link
                    href={`/produits/${item.slug}`}
                    onClick={onClose}
                    className="relative w-16 h-16 sm:w-20 sm:h-20 flex-shrink-0 bg-white rounded overflow-hidden"
                  >
                    <Image
                      src={item.image}
                      alt={item.name}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-primary font-bold text-sm sm:text-base mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center bg-white hover:bg-primary hover:text-white rounded border border-gray-300 transition-colors"
                      >
        ...
        {/* Footer */}
        {cartItems.length > 0 && (
          <div className="border-t p-3.5 sm:p-4 space-y-4">
            {/* Subtotal */}
